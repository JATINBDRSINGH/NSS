...
import { createEvent, isUserAdmin } from "@/lib/appwrite"
...
export default function NewEventPage() {
  ...
  async function onSubmit(values: z.infer<typeof eventSchema>) {
    ...
    try {
      await createEvent(values, eventImage)
    ...
    <div className="container py-12">
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center gap-2 mb-6">
          <Link href="/admin?tab=events" className="text-muted-foreground hover:text-primary">
        ...
        <Card>
          <CardHeader className="bg-gradient-to-r from-primary/10 to-transparent">
            ...
            <CardDescription>Create a new event to display on your website</CardDescription>
          </CardHeader>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <FormDescription className="text-center">Upload an event image (JPEG, PNG, WebP)</FormDescription>
                  </div>
                </div>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="science-fair" {...field} />
                        </FormControl>
                        <FormDescription>
                          A unique identifier for the event (e.g., "science-fair", "art-exhibition")
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea placeholder="A brief description of the event" className="resize-none" {...field} />
                      </FormControl>
                      <FormDescription>This will appear in event listings and cards</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          placeholder="A detailed description of the event, its activities, and goals"
                          className="min-h-[150px]"
                          {...field}
                        />
                      </FormControl>
                      <FormDescription>This will appear on the event's detail page</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="School Gymnasium" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                      ...
                      <FormItem>
                        ...
                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="tech">Technology Club</SelectItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Dr. Michael Roberts" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="event@example.com" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
